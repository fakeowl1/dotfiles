...
vim.g.lsp_on_attach = function(client, bufnr)
  ...
  nmap("<leader>fl", function() vim.lsp.buf.format({async = true}) end, "[F]ormat current buffer")
  ...
  nmap('<leader>e', vim.diagnostic.open_float, "[O]pen floating diagnostic message")  
end
